...
export default function TabelaCoordenador() {
  ...
  const fetchEntregadores = async () => {
    try {
      const requisicao = await fetch(
        `https://vel-tnpo.onrender.com/coordenador/idcnpj/${JSON.parse(
  ...
  return (
    <div className={style.conteiner}>
      ...
      <button className={style.botaoAdicionar} onClick={handleModalAdd}>
        + Novo Cadastro
      </button>
      ...
      <ModalPerfilEntregador
        ...
        onClose={() => handleModalPerfil(null)}
            ...
            <tr key={entregador.idCpf}>
              ...
              <td>
                <button
                  ...
                  onClick={() => handleModalPerfil(entregador)}
                >
