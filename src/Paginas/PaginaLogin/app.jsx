...
import LogoVEL from "/images/VEL.png";
...
function Login() {
  ...
  const verificaLogin = (e) => {
    ...
    if (user.email.length <= 1 || user.senha.length <= 1)
          ...
          <div className="form">
            ...
            <form>
              ...
              <div className="form-group-checkbox">
                ...
                <a onClick={() => navigate("/recuperarsenha")} style={{cursor: "pointer"}}>
                  Esqueceu sua senha?
                </a>
              </div>
            ...
            <div className="login-options">
              <p>
                Não garantiu seu plano?{" "}
                <a onClick={() => navigate("/inicial")} style={{cursor: "pointer"}}>cadastre-se agora</a>
              </p>
            </div>
          </div>
        </div>
